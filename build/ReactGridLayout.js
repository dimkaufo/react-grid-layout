...
var _ReactGridLayoutPropTypes = _interopRequireDefault(
  require("./ReactGridLayoutPropTypes")
);
        ...
        value: function getDerivedStateFromProps(
          ...
          if (newLayoutBase) {
            var newLayout = (0, _utils.synchronizeLayoutWithChildren)(
              ...
              nextProps.children,
              nextProps.cols,
              (0, _utils.compactType)(nextProps)
            );
            return {
              layout: newLayout,
...
_defineProperty(
  ReactGridLayout,
  "propTypes",
  _ReactGridLayoutPropTypes.default
);
